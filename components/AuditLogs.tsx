...
interface AuditLog {
  id: string;
  type: 'ticket_reply' | 'profile_change' | 'tax_audit';
  timestamp: string;
  description: string;
  performedBy: string;
...
export function AuditLogs() {
  ...
  const allAuditLogs:  AuditLog[] = [
    ...
    { 
      id: '1004', 
      type: 'ticket_reply', 
      timestamp: '13-DEC-2025 02:45 PM', 
      description: 'Replied to support ticket #303', 
      performedBy: '1003', 
      performedByName: 'Nadia Islam', 
      performedByRank: 'Assistant',
      relatedTo: '5003',
      relatedToName: 'David Roy',
      details: { ticketId: '303', subject: 'Payment Failed', reply: 'We have located your payment.  It will be reflected in 2-3 business days.' }
    },
    ...
    { 
      ...
      relatedToName:  'Cina Akter',
      status: 'Pending',
      details: { returnId: '20002', reason:  'Doc Missing' }
    }
  ];
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-sm text-gray-600">Track all system activities including ticket replies, profile changes, and tax audits</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="bg-gradient-to-br from-orange-50 to-orange-100 rounded-lg shadow border border-orange-200 p-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              <p className="text-sm text-orange-700 mb-1 font-medium">Profile Changes</p>
                    ...
                    <div className="flex-1">
                        ...
                        {log.relatedTo && (
                          <div className="bg-blue-50 rounded-lg p-4 border border-blue-200">
                            ...
                            <p className="text-sm text-gray-600 mt-1">
                              {log.type === 'ticket_reply' || log.type === 'profile_change' ? 'TIN' : 'ID'}: {log.relatedTo}
                            </p>
                          </div>
                        )}
                      </div>
                      ...
                      {log.details && (
                        <div className="bg-gray-50 rounded-lg p-4 border border-gray-200">
                          ...
                          {log.type === 'profile_change' && log.details. changes && (
                            <div className="space-y-3">
                              {log.details.changes.map((change:  any, index: number) => (
                                <div key={index} className="flex items-center gap-3 p-3 bg-white rounded border border-orange-200">
                                  ...
                                  <div className="flex-1">
                                    ...
                                    <div className="flex items-center gap-2">
                                      ...
                                      <span className="text-sm font-semibold text-orange-700">{change.newValue}</span>
                                    </div>
                                  </div>
                                </div>
                              ))}
